...
def get_data(
    ...
    if train_all:
        filename = '/mnt/ceph/users/mcranmer/general_data/stability_dataset/all_jun2020v8_combined.pkl'
    elif plot_resonant:
        filename = '/mnt/ceph/users/mcranmer/general_data/stability_dataset/all_jun2020v8.pkl'
    elif plot_random:
        filename = '/mnt/ceph/users/mcranmer/general_data/stability_dataset/all_jun2020_randomv8.pkl'
